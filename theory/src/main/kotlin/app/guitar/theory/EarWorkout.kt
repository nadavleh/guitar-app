 ...
 *  version differences are expected. Mirrored in chorect-web earWorkout.ts. */

/** A named recording. [version] pins the performance the exercise was built on
 *  (covers/tutorials may change the harmony). */
 ...
 *  key (empty = no key, e.g. exams). [loop] is set only when the spoiler is a
 *  clean 4-bar diatonic loop the app can play back. */
...
data class DeepWeek(
    ...
    val section: String,
    val target: String,
    val melodyTarget: String,
    val notGraded: List<String>,
    val labDrills: List<String>,
    val passing: String,
    val spoiler: String = "",
    val loop: Progression? = null,
)
...
object EarWorkout {
    ...
    val SESSION_FRAME: List<Pair<String, String>> = listOf(
        "0–5" to "Guitarless listen: number of chord events, bass contour, chord-quality guesses, resolution points, outside/dominant-like sounds.",
        "5–18" to "Functional chord identification on guitar — function first, then quality: major, minor, dominant, diminished, maj7, m7.",
        "18–25" to "Speed loop: call out function + quality in time over a short 4–8 bar section.",
        "25–33" to "Melody playback: Month 1 allows note-by-note; Month 2 aims for 2–4 note chunks.",
        "33–42" to "Constrained harmonization: choose a functional chord that structurally contains the melody note.",
        "42–45" to "Play-through: bass → chords → melody → reharmonized version.",
    )

    const val MONTH1_RULE =
    ...
    const val MONTH1_GOAL = "Faster recognition of basic function and chord quality in real songs; first controlled exposure to outside dominant color."
    const val MONTH2_GOAL = "Faster recognition of 7th-chord quality, ii–V motion, secondary dominants, and first borrowed-color previews."

    private fun maj(vararg d: Int) = Progression(TrainingMode.Major, d.toList())

    /** Track A — 32 sessions (8 weeks × 4). */
    val SESSIONS: List<WorkoutSession> = listOf(
        // ---- Month 1 ----
        WorkoutSession(1, 1, "Core loop quality",
            WorkoutSong("Stand by Me", "Ben E. King", "original 1961 single"),
            ...
            loop = maj(1, 6, 4, 5)),
        WorkoutSession(2, 1, "Deceptive vs resolved motion",
            WorkoutSong("Let It Be", "The Beatles", "original"),
            ...
            loop = maj(1, 5, 6, 4)),
        WorkoutSession(3, 1, "Simple function, clean quality",
            WorkoutSong("I Can See Clearly Now", "Johnny Nash", "original"),
        ...
        WorkoutSession(4, 1, "Secondary-dominant preview",
            WorkoutSong("Something", "The Beatles", "original — opening/verse only"),
        ...
        WorkoutSession(5, 2, "Pre-dominant alternatives",
            WorkoutSong("Take Me Home, Country Roads", "John Denver", "original"),
        ...
        WorkoutSession(6, 2, "Same quality, different function",
            WorkoutSong("Brown Eyed Girl", "Van Morrison", "original"),
            ...
            loop = maj(1, 4, 1, 5)),
        WorkoutSession(7, 2, "Melody constrains harmony",
            WorkoutSong("Wonderful Tonight", "Eric Clapton", "original"),
        ...
        WorkoutSession(8, 2, "Slow secondary-dominant lab",
            WorkoutSong("You Are My Sunshine", "traditional", "version-dependent"),
        ...
        WorkoutSession(9, 3, "Familiar loop, quicker reaction",
            WorkoutSong("I'm Yours", "Jason Mraz", "original"),
            ...
            loop = maj(1, 5, 6, 4)),
        WorkoutSession(10, 3, "Avoided resolution",
            WorkoutSong("Have You Ever Seen the Rain", "Creedence Clearwater Revival", "original"),
        ...
        WorkoutSession(11, 3, "Optional excerpt lab: outside dominants",
            WorkoutSong("All of Me", "Billie Holiday", "1941 version with Lester Young — first 8 bars ONLY"),
        ...
        WorkoutSession(12, 3, "Common loop across style",
            WorkoutSong("No Woman, No Cry", "Bob Marley & The Wailers", "live (1975) or studio"),
            ...
            loop = maj(1, 5, 6, 4)),
        WorkoutSession(13, 4, "ii vs IV diagnosis",
            WorkoutSong("Knockin' on Heaven's Door", "Bob Dylan", "original 1973"),
        ...
        WorkoutSession(14, 4, "Dominant of dominant, slow context",
            WorkoutSong("Leaving on a Jet Plane", "John Denver", "or the Peter, Paul and Mary version"),
        ...
        WorkoutSession(15, 4, "Girl recovery lab",
            WorkoutSong("Girl", "The Beatles", "original — only two short loops"),
        ...
        WorkoutSession(16, 4, "Month 1 exam",
        ...
        // ---- Month 2 ----
        WorkoutSession(17, 5, "ii–V as one object",
            WorkoutSong("Fly Me to the Moon", "Frank Sinatra with Count Basie", "or a slow backing track"),
            ...
            loop = maj(6, 2, 5, 1)),
        WorkoutSession(18, 5, "Circle motion and quality",
            WorkoutSong("Autumn Leaves", "Cannonball Adderley / Miles Davis", "or a slow vocal version"),
        ...
        WorkoutSession(19, 5, "Minor-key function",
            WorkoutSong("Blue Bossa", "Kenny Dorham", "or the Dexter Gordon version"),
        ...
        WorkoutSession(20, 5, "Repeated cells",
            WorkoutSong("Satin Doll", "Duke Ellington"),
        ...
        WorkoutSession(21, 6, "Moving key centers",
            WorkoutSong("Tune Up", "Miles Davis", "slow it down if needed"),
        ...
        WorkoutSession(22, 6, "Dominant chains, slower",
            WorkoutSong("Dream a Little Dream of Me", "Ella Fitzgerald & Louis Armstrong"),
        ...
        WorkoutSession(23, 6, "All of Me review lab",
            WorkoutSong("All of Me", "Billie Holiday", "1941 — first 8 bars only"),
        ...
        WorkoutSession(24, 6, "Rich harmony reduction",
            WorkoutSong("Georgia on My Mind", "Ray Charles", "opening only"),
        ...
        WorkoutSession(25, 7, "Borrowed minor color",
            WorkoutSong("In My Life", "The Beatles", "original"),
        ...
        WorkoutSession(26, 7, "Modal rock color",
            WorkoutSong("Hey Jude", "The Beatles", "original"),
        ...
        WorkoutSession(27, 7, "Same melody, richer harmony",
            WorkoutSong("Sleep Walk", "Santo & Johnny", "original"),
            ...
            loop = maj(1, 6, 4, 5)),
        WorkoutSession(28, 7, "Girl structured return",
            WorkoutSong("Girl", "The Beatles", "original — verse fragment and chorus only"),
        ...
        WorkoutSession(29, 8, "Unfamiliar simple song",
        ...
        WorkoutSession(30, 8, "Unfamiliar standard-like song",
        ...
        WorkoutSession(31, 8, "Unfamiliar Beatles/classic-rock song",
        ...
        WorkoutSession(32, 8, "Month 2 exam",
    ...
    val DEEP_WEEKS: List<DeepWeek> = listOf(
        DeepWeek(1, "Stand by Me", "Ben E. King", "Original 1961 single recording",
            ...
            notGraded = listOf("The famous bass figure", "Exact instrumental voicings", "Optional seventh colour added by an individual instrument"),
            labDrills = listOf("Major triad vs major seventh", "Root position vs first inversion of a major triad", "A separate secondary-dominant-to-minor-resolution drill (not from the song)"),
            ...
            loop = Progression(TrainingMode.Major, listOf(1, 6, 4, 5))),
        DeepWeek(2, "La Bamba", "Ritchie Valens", "Original 1958 recording",
            ...
            notGraded = listOf("The opening guitar riff", "The exact strumming pattern", "Momentary suspensions/colour tones from melody and voicing"),
            labDrills = listOf("Major triad vs dominant seventh", "Root position vs first inversion", "A separate applied-dominant resolution drill"),
        ...
        DeepWeek(3, "Knockin' on Heaven's Door", "Bob Dylan", "Original 1973 soundtrack recording",
            ...
            notGraded = listOf("Guitar embellishments", "Added sevenths in simplified/performance charts", "Exact bass position during the dominant harmony"),
            labDrills = listOf("Minor triad vs minor seventh", "Root-position vs first-inversion dominant", "Dominant-to-minor resolution vs deceptive motion"),
        ...
        DeepWeek(4, "Believer", "Imagine Dragons", "Original 2017 studio recording",
            ...
            notGraded = listOf("Percussion layers and production effects", "Later-section bass inversions", "Exact instrumental doubling of chord tones"),
            labDrills = listOf("Minor vs major tonic", "Minor vs major dominant in a minor context", "Root position vs first inversion", "Applied-dominant drills pointing to two different minor-key destinations"),
        ...
        DeepWeek(5, "No Woman, No Cry", "Bob Marley and the Wailers", "1975 Live! version (Lyceum Theatre, London)",
            ...
            notGraded = listOf("Organ fills", "Reggae accompaniment rhythm", "Melodic decorations", "Exact seventh/suspension colour unless it changes the chord identity"),
            labDrills = listOf("Root position vs first inversion of major chords", "Bass root vs bass third", "Dominant triad vs dominant seventh", "A separate secondary-dominant-to-supertonic drill"),
            ...
            loop = Progression(TrainingMode.Major, listOf(1, 5, 6, 4))),
        DeepWeek(6, "Use Me", "Bill Withers", "Original 1972 studio recording (Still Bill)",
            ...
            notGraded = listOf("The clavinet riff", "The bass riff", "Percussion complexity", "Any extension beyond basic seventh-chord identity"),
            labDrills = listOf("Minor seventh vs dominant seventh", "Major seventh vs minor seventh", "All three seventh qualities in shell voicings", "Separate secondary-dominant exercises outside the song"),
        ...
        DeepWeek(7, "Hallelujah", "Jeff Buckley", "1994 Grace album recording",
            ...
            notGraded = listOf("Buckley's fingerpicked voicings", "Exact picking pattern", "Extensions and open-string colour tones", "The complete song form"),
            labDrills = listOf("Diatonic motion to a minor chord vs applied-dominant motion to it", "Dominant triad vs dominant seventh", "Applied dominant with and without its seventh", "Mixed inversion review"),
        ...
        DeepWeek(8, "Consolidation — no new song", "", "All seven named recordings from weeks 1–7",
    ...
    val TRAIN_DRILLS: List<Pair<String, String>> = listOf(
        "Diatonic 7ths" to "Imaj7–vi7–IVmaj7–V7  |  Imaj7–vi7–ii7–V7  |  vi7–ii7–V7–Imaj7",
        "Secondary dominants" to "Imaj7–V/V–V7–Imaj7  |  Imaj7–V/vi–vi7  |  Imaj7–V/ii–ii7–V7",
        "Dominant chains" to "Imaj7–III7–vi7–II7–V7–Imaj7  |  Imaj7–VI7–ii7–V7",
        "Borrowed preview" to "Imaj7–IVmaj7–iv–Imaj7  |  Imaj7–bVII–IVmaj7–Imaj7",
        "Quick questions" to "Diatonic or outside? maj7, m7 or dom7? Where does the dominant want to resolve? Is this ii–V–I? Is this borrowed color?",
    )

    /** Month 1 / Month 2 examination targets (skill → target). */
    val MONTH1_EXAM: List<Pair<String, String>> = listOf(
        "Synthetic major/minor triad quality" to "8/10",
        "Broad functional category in ordinary loops" to "7/10",
        "Minor dominant vs major dominant in minor" to "7/10",
        "Melody reproduction" to "Five notes within five guitar attempts",
        "Simple harmonization" to "One plausible triad per structural melody note",
        "Secondary-dominant awareness" to "Hear an unexpected dominant pull; exact label not yet required",
    )
    val MONTH2_EXAM: List<Pair<String, String>> = listOf(
        "Correct roots/functions in an eight-event excerpt" to "At least 6/8",
        "Major/minor/dominant broad quality" to "At least 8/10",
        "Maj7, m7 and dom7 in shell voicings" to "At least 7/10",
        "Root position vs first inversion" to "At least 7/10",
        "Identify the target of an applied dominant" to "At least 7/10",
        "Six-to-eight-note melody" to "Correct contour, ≥75% exact pitches",
        "Triadic harmonization" to "Plausible choice for ≥75% of structural notes",
    )

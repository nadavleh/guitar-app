...
object IntervalSongs {
    ...
    private fun asc(i: String, long: String, inv: String, song: String, artist: String, cue: String) =
        IntervalSongRef(true, i, long, inv, song, artist, cue)
    private fun desc(i: String, long: String, inv: String, song: String, artist: String, cue: String) =
        IntervalSongRef(false, i, long, inv, song, artist, cue)

...
export const APP_VERSION = "2.72.4";
...
export enum Sheet { Fretboard = "Fretboard", Options = "Options", Tuner = "Tuner", Loop = "Loop", EarTraining = "EarTraining", SambaLooper = "SambaLooper", Decompose = "Decompose", CavaqProgressions = "CavaqProgressions", RhythmUnits = "RhythmUnits", Metronome = "Metronome", ScalesTriads = "ScalesTriads", Theory = "Theory", Songs = "Songs" }
...
export type TabDestName = "Neck" | "Ear" | "Rhythm" | "Loop" | "Tuner" | "Decompose" | "CavaqProgressions" | "RhythmUnits" | "Metronome" | "ScalesTriads" | "Theory" | "Songs";
export const ALL_TAB_DESTS: readonly TabDestName[] = ["Neck", "Ear", "Rhythm", "Loop", "Tuner", "Decompose", "CavaqProgressions", "RhythmUnits", "Metronome", "ScalesTriads", "Theory", "Songs"];
